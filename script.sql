...
VALUES
    ...
    (
        ...
        '2023-05-30 18:00:00',
        0,
        NULL, -- No physical location for online
        '2023-05-01 14:00:00',
        'Active',
        1,
...
-- Inserting more data into userActivityHistory table
-- INSERT INTO `unityDoDB`.`userActivityHistory` (`userId`, `activityId`)
-- VALUES
--     (1, 31), (4, 32), (5, 33), (1, 34), (4, 35),
--     (5, 36), (1, 37), (4, 38), (5, 39), (1, 40),
--     (4, 31), (5, 32), (1, 33), (4, 34), (5, 35),
--     (1, 36), (4, 37), (5, 38), (1, 39), (4, 40),
--     (5, 31), (1, 32), (4, 33), (5, 34), (1, 35),
--     (4, 36), (5, 37), (1, 38), (4, 39), (5, 40),
--     (1, 31), (4, 32), (5, 33), (1, 34), (4, 35),
--     (5, 36), (1, 37), (4, 38), (5, 39), (1, 40),
--     (4, 31), (5, 32), (1, 33), (4, 34), (5, 35),
--     (1, 36), (4, 37), (5, 38), (1, 39), (4, 40),
...
--     INSERT INTO `unityDoDB`.`userActivityHistory` (`userId`, `activityId`)
-- VALUES
--     (1, 21), (4, 22), (5, 23), (1, 24), (4, 25),
--     (5, 26), (1, 27), (4, 28), (5, 29), (1, 30),
-- 	(1, 21), (4, 22), (5, 23), (1, 24), (4, 25),
--     (5, 26), (1, 27), (4, 28), (5, 29), (1, 30),
-- 	(1, 21), (4, 22), (5, 23), (1, 24), (4, 25),
--     (5, 26), (1, 27), (4, 28), (5, 29), (1, 30),
